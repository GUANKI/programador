        ...
        <script>
            $(document).ready(function() {
                ...
                $('#programarModal').on('hidden.bs.modal', function() {
                    // Limpiar los días seleccionados
                    selectedDates = [];
            ...
            $(document).ready(function() {
                ...
                $('#calendar').on('eventClick', function(info) {
                    ...
                    $('#event-id').val(info.event.extendedProps.id); // Almacena el ID del evento
                ...
                $('#delete-event').on('click', function() {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            // Eliminar el evento del calendario sin recargar todos los eventos
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <button type="button" class="btn-close" id="cerradito" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
        ...
        <div class="modal fade" id="infoModal" tabindex="-1" aria-labelledby="infoModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cerrar</button>
                        <button type="button" class="btn btn-danger" id="delete-event" data-bs-dismiss="modal">Eliminar</button>
                    </div>
                </div>
            </div>
        </div>